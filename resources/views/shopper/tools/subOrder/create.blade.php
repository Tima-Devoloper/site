...
<div class="container">
    <div class="container">
        <form  class="needs-validation" action="{{ route('subOrder.storeShopper')}}" method="post">
            @csrf
            ...
            @for($i = 0 ; $i < ($request->count) ; $i++ )
                <div class="form-row">
                    ...
                    <input type="number" class="form-control" name="{{1000+ $i}}" placeholder="Кол-во" required>
                    </div>
                </div>
                <hr>
                <br>
